...
public class CustomAdapterReadAyah extends ArrayAdapter {
    private final Activity context;
    private final int[] SurahId;
    private final String[] SurahNameEnglish;
    private final String[] SurahNameUrdu;

    public CustomAdapterReadAyah(Activity context, String[] SurahNameEnglish, String[] SurahNameUrdu, int[] SurahId) {
